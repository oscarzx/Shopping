    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, EditProductViewModel model)
        {
            ...
            try
            {
                ...
                {
                    isValid = true,
                    html = ModalHelper.RenderRazorViewToString(this, "_ViewAllProducts",
                    _context.Products
                    .Include(p => p.ProductImages)
                    .Include(p => p.ProductCategories)
                    .ThenInclude(pc => pc.Category)
        ...
        public async Task<IActionResult> AddImage(AddProductImageViewModel model)
        {
            ...
            return Json(new { isValid = false, html = ModalHelper.RenderRazorViewToString(this, "AddImage",
                model) });
        }
        ...
        public async Task<IActionResult> AddCategory(AddCategoryProductViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        isValid = true,
                        html = ModalHelper.RenderRazorViewToString(this, "Details",
                        _context.Products
                        .Include(p => p.ProductImages)
                        .Include(p => p.ProductCategories)
                        .ThenInclude(pc => pc.Category)
            ...
            {
                isValid = false,
                html = ModalHelper.RenderRazorViewToString(this, "AddCategory",
                model)
            });
        }
