        ...
        public async Task<IActionResult> AddState(StateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Ya existe un departamento/estado con el mismo nombre de este país");
                    }
                    else
                    {
        ...
        public async Task<IActionResult> EditState(int id, StateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        _flashMessage.Danger("Ya existe un departamento/estado con el mismo nombre de este país");
                    }
                    else
                    {
        ...
        public async Task<IActionResult> EditCity(int id, CityViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        _flashMessage.Danger("Ya existe una ciudad con el mismo nombre de este departamento/estado");
                    }
                    else
                    {
                        _flashMessage.Danger(dbUpdateException.InnerException.Message);
